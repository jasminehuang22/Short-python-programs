...
def play_game(state):
    ...
    while state['room']!= 'exit':
        ...
        process_points_and_health(state)
...
def process_points_and_health(state):
    '''processes how much health and how many points you have left '''
...
def process_entry(state):
    ...
    response2 = input("Do you want to go to work? (y or n): ")
    if response=='y':
        state['room']= 'kitchen'
    elif response2=='y':
        state['room']='office'
